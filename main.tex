...
In this work the value is set to $\alpha = 0.9$, but further testing and tuning could be required. For what regards the initial and last values of the dataset,
