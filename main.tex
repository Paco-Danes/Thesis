...
as an essential reference point for tackling this complex problem. A great number of hyperparameters could be tested, starting from the preprocessing phase of the data up to model's layers, regularization and training. The dataset collected is brand new, and future endeavors could significantly
enhance this dataset by incorporating a more extensive range of subjects, capturing diverse body poses and orientations, a wider variety of clothing and personal accessories, and even introducing variations in background environments, such as different rooms, furnishings, open spaces, and outdoor scenarios.
